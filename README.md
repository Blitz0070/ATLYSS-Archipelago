...
1. **Install Archipelago** — Download and install [Archipelago 0.6.5 or later](https://github.com/ArchipelagoMW/Archipelago/releases).
...
5. **Install Archipelago and the world** — r2modman does not manage Archipelago. Install Archipelago 0.6.5 or later separately, then add `atlyss.apworld` under `custom_worlds/` as in [Manual Installation](#manual-installation).
